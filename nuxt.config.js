export default {
  ...
  head: {
    ...
    meta: [
      ...
      { hid: 'og:image' , property: 'og:image' , content: 'https://dx35vtwkllhj9.cloudfront.net/trafalgarreleasing/blackpink/images/regions/gb/onesheet.jpg' },
    ...
    link: [
      ...
      { rel: 'stylesheet', href: 'https://fonts.googleapis.com/css2?family=Oswald:wght@500&family=Roboto:wght@700&display=swap'},
    ]
  },
